...
int program(int blsize,int l1size ,int l1assoc ,int l2size ,int l2assoc, char *argv[]){
...
int main(int argc, char* argv[])
{
    ...
    ofstream myfile("trace_answer.txt", ios::app);
    int defa[5] = {64, 1024, 2, 65536, 8};
    int blocksz[5] = {8, 16, 32, 64, 128};
    int l1size[5] = {512, 1024, 2048, 4096, 8192};
    int l1assoc[5] = {1, 2, 4, 8, 16};
    int l2size[5] = {16384, 32768, 65536, 131072, 262144};
    int l2assoc[5] = {1, 2, 4, 8, 16};
    int overall[5][5] = {{8, 16, 32, 64, 128},
                          {512, 1024, 2048, 4096, 8192},
                          {1, 2, 4, 8, 16},
                          {16384, 32768, 65536, 131072, 262144},
                          {1, 2, 4, 8, 16}};
    // for (int mondal=1;mondal<9;mondal++)
    // {
    //     myfile<< string("trace ") + to_string(mondal)+"answers"<<endl;
    //     cout<<"Raja"<<endl;
    // for (int i = 0; i < 5; i++)
    // {
    //     // cout<<"raja";
    //     myfile << "part" << to_string(i+1) << "time = [";
    //     for (int j = 0; j < 5; j++)
    //     {
    //         int v[5];
    //         for (int k = 0; k < 5; k++)
    ...
    //         }
    //         v[i] = overall[i][j];
    //         int answer = program(v[0], v[1], v[2], v[3], v[4], &argv[mondal]);
    //         if (j != 4)
    //         {
    //             myfile << to_string(answer) << ",";
    //         }
    //         else
    //         {
    //             myfile << to_string(answer) << "]" << endl;
    //         }
    //     }
    // }
    // }
